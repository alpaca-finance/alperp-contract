...
const REWARDER = config.Staking.ALPStaking.rewarders.find(
  (each: any) => each.name === "ALP Staking Protocol Revenue"
);
const AMOUNT = "7500";
const DURATION = "604800"; // 1 weeks in seconds
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`> ✅ Executed FeedRevenueRewarder`);
};

export default func;
func.tags = ["FeedRevenueRewarder"];
