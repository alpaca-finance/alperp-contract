...
contract PoolDiamond_FundingRateTest is PoolDiamond_BaseTest {
  ...
  function testCorrectness_BorrowingRate() external {
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(wbtc), address(wbtc), 90 * 10 ** 30, true
    );
    ...
    GetterFacetInterface.GetPositionReturnVars memory position = poolGetterFacet
      ...
      address(this), 0, address(wbtc), address(wbtc), true
    );
    ...
    poolPerpTradeFacet.decreasePosition(
      address(this), 0, address(wbtc), address(wbtc), 1 * 10 ** 30, 0, true, BOB
    );
  ...
  function testCorrectness_FundingRate_LongOnly() external {
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(wbtc), address(wbtc), 360_000 * 10 ** 30, true
    );
    ...
    assertEq(
      poolGetterFacet.openInterestLong(address(wbtc)), 8.7804878 * 10 ** 8
    );
    ...
    (int256 fundingRateLong, int256 fundingRateShort) =
      poolGetterFacet.getNextFundingRate(address(wbtc));
  ...
  function testCorrectness_FundingRate_LongPayShort_TwoToOne() external {
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(dai), address(wbtc), 180_000 * 10 ** 30, false
    );
    ...
    assertEq(
      poolGetterFacet.openInterestShort(address(wbtc)), 4.3902439 * 10 ** 8
    );

    // Checking the position delta right after opening the position
    // Position should not have any delta or funding fee
    (bool isProfitLong, uint256 deltaLong, int256 fundingFeeLong) =
    ...
    (bool isProfitShort, uint256 deltaShort, int256 fundingFeeShort) =
    poolGetterFacet.getPositionDelta(
      address(this), 0, address(dai), address(wbtc), false
    );
    ...
    (isProfitLong, deltaLong, fundingFeeLong) = poolGetterFacet.getPositionDelta(
      address(this), 0, address(wbtc), address(wbtc), true
    );
    ...
    // No change in ALP AUM as there is no realized positions
    ...
    (uint256 fundingFeePayable, uint256 fundingFeeReceivable) =
      poolGetterFacet.getFundingFeeAccounting();
    ...
    (fundingFeePayable, fundingFeeReceivable) =
      poolGetterFacet.getFundingFeeAccounting();
    ...
    external
  {
    ...
    assertEq(fundingFeeReceivable, 0);
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(dai), address(wbtc), 360_000 * 10 ** 30, false
    );
    (isProfitShort, deltaShort, fundingFeeShort) = poolGetterFacet
      .getPositionDelta(address(this), 0, address(dai), address(wbtc), false);
    ...
    external
  {
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(wbtc), address(wbtc), 1025000 * 10 ** 30, true
    );
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(dai), address(wbtc), 615000 * 10 ** 30, false
    );
  ...
  function testCorrectness_FundingRate_ShortPayLong_TwoToOne() external {
    ...
    wbtc.mint(address(poolDiamond), 1 * 10 ** 8);
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(wbtc), address(wbtc), 180_000 * 10 ** 30, true
    );
    ...
    // = 360000 / 41000 = 8.7804878 WBTC
    assertEq(
      poolGetterFacet.openInterestLong(address(wbtc)), 4.3902439 * 10 ** 8
    );
    assertEq(
      poolGetterFacet.openInterestShort(address(wbtc)), 8.7804878 * 10 ** 8
    );
    ...
    external
  {
    ...
    wbtc.mint(address(poolDiamond), 1 * 10 ** 8);
    poolPerpTradeFacet.increasePosition(
      address(this), 1, address(wbtc), address(wbtc), 180_000 * 10 ** 30, true
    );
    ...
    dai.mint(address(poolDiamond), 10000 ether);
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(dai), address(wbtc), 100_000 * 10 ** 30, false
    );
    ...
    dai.mint(address(poolDiamond), 10000 ether);
    poolPerpTradeFacet.increasePosition(
      address(this), 1, address(dai), address(wbtc), 100_000 * 10 ** 30, false
    );
    ...
    dai.mint(address(poolDiamond), 10000 ether);
    poolPerpTradeFacet.increasePosition(
      address(this), 2, address(dai), address(wbtc), 70_000 * 10 ** 30, false
    );
    ...
    assertEq(
      poolGetterFacet.openInterestLong(address(wbtc)), 13.1707317 * 10 ** 8
    );
    assertEq(
      poolGetterFacet.openInterestShort(address(wbtc)), 6.58536585 * 10 ** 8
    );
    ...
    position = poolGetterFacet.getPosition(
      address(this), address(dai), address(wbtc), false
    );
    ...
    external
  {
    ...
    poolPerpTradeFacet.liquidate(
      address(this), 0, address(wbtc), address(wbtc), true, address(this)
    );
    ...
    poolPerpTradeFacet.liquidate(
      address(this), 0, address(dai), address(wbtc), false, address(this)
    );
  ...
  function testCorrectness_FundingRate_LongPayShort_TwoToOne_LiquidatePartialPositions(
    ...
    poolPerpTradeFacet.liquidate(
      address(this), 1, address(wbtc), address(wbtc), true, address(this)
    );
  ...
  function testCorrectness_FundingRate_LongPayShort_HugeDiff() external {
    ...
    poolPerpTradeFacet.increasePosition(
      address(this), 0, address(dai), address(wbtc), 7 * 10 ** 30, false
    );
    ...
    assertEq(
      poolGetterFacet.openInterestShort(address(wbtc)), 0.00017073 * 10 ** 8
    );
