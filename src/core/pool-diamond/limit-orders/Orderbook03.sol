...
import { IOnchainPriceUpdater02 } from "../../../interfaces/IOnChainPriceUpdater02.sol";
...
contract Orderbook03 is ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  IOnchainPriceUpdater02 public oraclePriceUpdater;
  ...
  function initialize(
    ...
    oraclePriceUpdater = IOnchainPriceUpdater02(_oraclePriceUpdater);
  }
